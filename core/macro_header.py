...
Handles global index retrieval with primary-to-proxy ticker failover, timezone calculation, and market hours tracking.
"""
...
def fetch_index_data(primary_ticker: str, fallback_ticker: str = None) -> Dict[str, Any]:
    """
    Fetches ticker price with explicit proxy failover to guarantee live US & Indian market metrics.
    """
...
def get_macro_header_data() -> Dict[str, Any]:
    """Fetches real-time dashboard macro index data."""
